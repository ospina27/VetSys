...
public class SearchUser extends javax.swing.JFrame {
    ...
    /*private void loadClinics() {
        ...
        List<Clinic> clinics = clinicDAO.
        
        cboxClinic.removeAllItems();
        for (Clinic clinic : clinics) {
            cboxClinic.addItem(clinic);
        }
    }*/
    //cargar las clinicas cmbox
    private void loadClinics() {
        ClinicDAO clinicDAO = new ClinicDAO();
        List<Clinic> clinics = clinicDAO.ReadAll(); 

        cboxClinic.removeAllItems();

        if (clinics != null && !clinics.isEmpty()) {
            for (Clinic clinic : clinics) {
                cboxClinic.addItem(clinic); // agrega el objeto completo
            }
        } else {
            System.out.println("No se encontraron clínicas en la base de datos.");
        }
    }
    ...
    private void loadAllUsers() {
        ...
        List<User> users = userDAO.ReadAll(); //cargar todos a latbla
    ...
    // Filtro por clínica seleccionada
    private void loadUsersByClinic() {
        Object selectedItem = cboxClinic.getSelectedItem();

        if (!(selectedItem instanceof Clinic)) {
            System.out.println("No hay clínica seleccionada o el objeto no es válido.");
            return;
        }

        Clinic selectedClinic = (Clinic) selectedItem;
        int clinicId = selectedClinic.getId_clinic();

        UserDAO userDAO = new UserDAO();
        List<User> users = userDAO.ReadByClinic(clinicId);
    ...
    // Listener para el filtro por clínica
    private void initListeners() {
        cboxClinic.addActionListener(e -> loadUsersByClinic());
    }
    ...
    private void initComponents() {
        ...
        cboxClinic = new javax.swing.JComboBox<>();
        ...
        cboxClinic.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cboxClinicActionPerformed(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(cboxClinic, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel6))
                .addGap(73, 298, Short.MAX_VALUE))
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addContainerGap()
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        try {
            ...
            if (updated) {
                ...
                loadUsersByClinic(); // refrescar tabla
            } else {
    ...
    private void cboxClinicActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboxClinicActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cboxClinicActionPerformed
    ...
    private javax.swing.JComboBox<Clinic> cboxClinic;
