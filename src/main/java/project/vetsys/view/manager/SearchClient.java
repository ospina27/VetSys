...
public class SearchClient extends javax.swing.JFrame {
    ...
    cmboxMembresias.setNextFocusableComponent(jFormattedTxtFechaInicioMembresia);

    jFormattedTxtFechaInicioMembresia.getAccessibleContext().setAccessibleName("Fecha inicio membresía");
    jFormattedTxtFechaInicioMembresia.getAccessibleContext().setAccessibleDescription("Fecha de inicio de la membresía");
    jFormattedTxtFechaInicioMembresia.setToolTipText("Fecha inicio (yyyy/mm/dd) (Alt+F)");
    jFormattedTxtFechaInicioMembresia.setNextFocusableComponent(jFormattedTxtFechaFinMembresia);

    jFormattedTxtFechaFinMembresia.getAccessibleContext().setAccessibleName("Fecha fin membresía");
    jFormattedTxtFechaFinMembresia.getAccessibleContext().setAccessibleDescription("Fecha de finalización de la membresía");
    jFormattedTxtFechaFinMembresia.setToolTipText("Fecha fin (yyyy/mm/dd) (Alt+G)");
    jFormattedTxtFechaFinMembresia.setNextFocusableComponent(txtDocumentoIngresado);
