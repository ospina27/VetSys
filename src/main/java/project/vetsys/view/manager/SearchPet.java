...
public class SearchPet extends javax.swing.JFrame {
    ...
    bredPet_lbl.setLabelFor(bredPet_Field);
    bredPet_lbl.setDisplayedMnemonic('R');
    bredPet_Field.setToolTipText("Raza de la mascota (Alt + R)");
    bredPet_Field.getAccessibleContext().setAccessibleName("Raza de la mascota");
    bredPet_Field.getAccessibleContext().setAccessibleDescription("Ingrese la raza de la mascota");
    ...
    dateBirthPet_lbl.setLabelFor(dateOfBirthPet_field);
    dateBirthPet_lbl.setDisplayedMnemonic('F');
    dateOfBirthPet_field.setToolTipText("Fecha de nacimiento de la mascota (yyyy-mm-dd) (Alt + F)");
    dateOfBirthPet_field.getAccessibleContext().setAccessibleName("Fecha de nacimiento");
    dateOfBirthPet_field.getAccessibleContext().setAccessibleDescription("Ingrese la fecha de nacimiento de la mascota en formato yyyy-mm-dd");
    ...
    emailOwner_lbl.setLabelFor(emailOwner_field);
    emailOwner_lbl.setDisplayedMnemonic('O');
    emailOwner_field.setToolTipText("Correo del propietario (no editable) (Alt + O)");
    emailOwner_field.getAccessibleContext().setAccessibleName("Correo del propietario");
    emailOwner_field.getAccessibleContext().setAccessibleDescription("Muestra el correo del propietario, no editable");

    phoneOwner_lbl.setLabelFor(phoneOwner_field);
    phoneOwner_lbl.setDisplayedMnemonic('T');
    phoneOwner_field.setToolTipText("Teléfono del propietario (no editable) (Alt + T)");
    phoneOwner_field.getAccessibleContext().setAccessibleName("Teléfono del propietario");
    phoneOwner_field.getAccessibleContext().setAccessibleDescription("Muestra el teléfono del propietario, no editable");
    ...
    btnSearchDocumet_client1.setMnemonic('R'); // Alt + R
    btnSearchDocumet_client1.setToolTipText("Refrescar la lista de mascotas (Alt + R)");
    btnSearchDocumet_client1.getAccessibleContext().setAccessibleName("Refrescar tabla");
    btnSearchDocumet_client1.getAccessibleContext().setAccessibleDescription("Refrescar la tabla de mascotas");
